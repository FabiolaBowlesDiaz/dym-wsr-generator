"""
Script para debuggear el cálculo de PY 2025 para Branca
...
print("="*80)
print("ANÁLISIS PY 2025 PARA BRANCA - DÍA 27 (SEMANA 4)")
print("="*80)
print()

# 1. VENTAS REALES POR CIUDAD (S1, S2, S3) - SIN Oruro/Trinidad
print("1. VENTAS REALES BRANCA POR CIUDAD (Semanas 1, 2, 3) - Ciudades con Gerente")
print("-"*80)
...
print("2. PROYECCIONES GERENTES BRANCA POR CIUDAD (Semanas 4 y 5)")
print("-"*80)
...
if not df_proy.empty:
    ...
    print("No hay proyecciones de gerentes para Branca")
    print()
print()
print()
...
WHERE EXTRACT(YEAR FROM CAST(tiempo_key AS DATE)) = 2025
    ...
    AND UPPER(marcadirectorio) = 'BRANCA'
...
if not df_sop.empty:
    ...
    print("No hay datos de SOP para Oruro/Trinidad con Branca")
    print()
...
if not df_ventas_ot.empty:
    ...
    print("No hay ventas reales para Oruro/Trinidad con Branca")
    print()
...
# 5. CÁLCULO FINAL
print("="*80)
print("CÁLCULO FINAL PY 2025 BRANCA")
print("="*80)
print()
...
print()
print("-"*80)
print(f"PY 2025 BRANCA TOTAL (Manual):    {total_ventas_reales + total_proy_gerentes + total_ventas_ot + total_sop_ot:>15,.2f} BOB")
print("="*80)
print()
...
branca = result[result['marcadir'].str.upper() == 'BRANCA']

if not branca.empty:
    py_query = branca['py_2025_bob'].values[0]
    ...
    print("No se encontró Branca en el resultado del query")
